    ...
    <div class="head-section">
        <div class="container-fluid">
            <div class="row" style="align-items: center;">
                ...
                @if(calc_work_day())
                    <div class="icon">
                        <a type="button" href="{{url('cart')}}" target="_blank" style="text-decoration: none;"> <i class="fa fa-shopping-cart" style="font-size: 30px;"></i>
                        </a>
                    </div>
                    @endif
                </div>
...
@endif
    ...
    <script>
        ...
        $('#myCarousel1').owlCarousel({
            ...
            animateOut: 'fadeOut',
            autoplay: false,
            navText: ['<a ><i class="fa fa-long-arrow-left" aria-hidden="true"></i></a>', '<a ><i class="fa fa-long-arrow-right" aria-hidden="true"></i></a>'],
    ...
    <script>
        ...
        $(document).ready(function(){
            $(".waiter").click(function(){
                if(confirm('{{__("messages.waiter_call_alert")}}')){
                    $.ajax({
                        type:"GET",
                        url:'{{url("call_waiter")}}',
