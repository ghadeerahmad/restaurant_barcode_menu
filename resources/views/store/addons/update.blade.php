...
<div id="main">
    <div class="container col-md-6 shadow-lg">
        <form action="{{url('store/addons/update',$addon->id)}}" method="POST">
            @csrf
            @error('errors')
            ...
            <div class="input-group mb-3">
                <input type="number" class="form-control" placeholder="price" aria-label="price" name="price" aria-describedby="basic-addon1" value="{{$addon->price}}">
