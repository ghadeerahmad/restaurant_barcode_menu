...
<section id="main">
    <div class="container col-md-11 shadow-lg">
        <form action="{{url('store/coupons/add')}}" method="POST">
            @csrf
            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" name="discount" placeholder="{{__('coupons.discount')}}" value="{{old('discount')}}">
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="mb-3">
                        ...
                        <select name="discount_type" class="selectpicker form-control">
                            <option value="PERCENT">{{__('coupons.percent')}}</option>
                            <option value="AMOUNT">{{__('coupons.amount')}}</option>
                        </select>
                    </div>
                </div>
                <div class="col-md-3">
                    <label class="form-label">{{__('coupons.code')}}</label>
                    <input type="text" class="form-control" name="code" placeholder="{{__('coupons.code')}}" value="{{old('code')}}">
                </div>
                <div class="col-md-3">
