...
@section('title',__('chef.update_category'))
@section('css')
                ...
                <div class="form-form-wrap" style="width: 100%;">
                    <div class="form-container">
                        <div class="form-content">
                            <form method="POST" action="{{url('store/categories/update',$cate->id)}}">
                                <div class="form">
                                    @csrf
                                    @error('errors')
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="name_ar" value="{{$cate->name_ar}}">
                                        @error('name_ar')
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="name_en" value="{{$cate->name_en}}">
                                        @error('name_en')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-control" name="is_active">
                                            <option value="1" @if($cate->is_active == 1) {{'selected'}} @endif>{{__('chef.yes')}}</option>
                                            <option value="0" @if($cate->is_active == 0) {{'selected'}} @endif>{{__('chef.no')}}</option>
                                        </select>
                                        @error('is_active')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                    ...
                                    <input type="hidden" id="logo" name="image" value="{{$cate->image}}">
                                    <div class="mb-3">
                                        <div class="row">
                                                ...
                                                <div class="image_area">
                                                    <form method="post">
                                                        <label for="upload_image">
                                                            <img src="@if($cate->image != null) {{ asset('storage'.$cate->image) }} @else {{asset('storage/stores/shops.png')}} @endif" id="uploaded_image" class="img-responsive img-circle" />
