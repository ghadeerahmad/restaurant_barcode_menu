...
<div class="container col-md-11 shadow-lg">
    <form method="POST" action="{{url('admin/themes/create')}}" enctype="multipart/form-data">
        @csrf
        @if($errors->any())
        ...
        <div class="form-floating mb-3">
            <input type="text" class="form-control" name="name" id="floatingInput" placeholder="{{__('themes.name')}}">
