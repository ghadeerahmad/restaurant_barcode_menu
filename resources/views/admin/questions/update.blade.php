        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-floating mb-3">
                    <input type="text" class="form-control" name="question_ar" value="{{$question->question_ar}}" id="floatingInput" placeholder="{{__('questions.question_ar')}}">
                    <label for="floatingInput">{{__('questions.question_ar')}}</label>
                </div>
                <div class="mb-3">
                    <label class="form-label">{{__('questions.answer_ar')}}</label>
                    <textarea name="answer_ar" id="editor1">{{$question->answer_ar}}</textarea>
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-floating mb-3">
                    <input type="text" class="form-control" name="question_en" value="{{$question->question_en}}" id="floatingInput" placeholder="{{__('questions.question_en')}}">
                    <label for="floatingInput">{{__('questions.question_en')}}</label>
                </div>
                <div class="mb-3">
                    <label class="form-label">{{__('questions.answer_en')}}</label>
                    <textarea name="answer_en" id="editor2">{{$question->answer_en}}</textarea>
                </div>
            </div>
        </div>
