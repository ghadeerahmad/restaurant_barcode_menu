...
<section id="main">
    <div class="container col-md-10 shadow-lg">
        <form action="{{url('admin/site_privilege/update',$privilege->id)}}" method="POST">
            @csrf
            @if($errors->any())
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" value="{{$value->id}}" @foreach($privilege_roles as $rl) @if($rl->site_role_id == $value->id) {{'checked'}} @endif @endforeach name="roles[]" id="flexCheckDefault">
